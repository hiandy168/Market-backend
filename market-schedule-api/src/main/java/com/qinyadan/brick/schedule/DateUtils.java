...
public class DateUtils {
	...
	public String getDateFormat(String time) {
		String[] formats = { REGX_YYYY_MM_DD_H_MM_SS, REGX_YYYY_MM_DD_HH_M_SS, REGX_YYYY_MM_DD_HH_MM_S,
				REGX_YYYY_MM_DD_HH_MM_SS, REGX_YYYY_MM_DD_H_M_S, REGX_YYYY_MM_DD_H_M_SS };
