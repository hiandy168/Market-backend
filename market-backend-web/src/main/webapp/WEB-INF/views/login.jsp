...
<header id="header" class="container" style="margin:0 auto;">
    <!--<span id="logo"></span>-->
        ...
        <div class="row">
            <div>
                ...
                <ul class="list-inline text-center">
                    ...
                    <li>
                        <a href="javascript:void(0);" class="btn btn-info btn-circle"><i class="fa fa-wechat"></i></a>
                    </li>
                    <li>
                        <a href="javascript:void(0);" class="btn btn-warning btn-circle"><i class="fa fa-pinterest"></i></a>
                    </li>
                </ul>
